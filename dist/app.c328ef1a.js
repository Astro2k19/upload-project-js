...
function uploadFiles(selector, options) {
  ...
  var uploadBtn = element('button', ['btn', 'upload-btn', 'primary'], 'Загрузить');
  ...
  var changeHandler = function changeHandler(event) {
    ...
    uploadedFiles.forEach(function (file) {
      ...
      fileReader.onload = function (event) {
        ...
        preview.insertAdjacentHTML('afterbegin', "<div class=\"preview__item\">\n                    <div class=\"preview__btn-cancel\" data-name=\"".concat(file.name, "\">&times;</div>\n                    <img src=\"").concat(src, "\" alt=\"").concat(file.name, "\"/>\n                    <div class=\"preview__item-info\">\n                        <span>").concat(file.name.length <= 23 ? file.name : file.name.slice(0, 18) + '...', "</span>\n                        <spam>").concat(formatBytes(file.size), "</spam>\n                    </div>\n                </div>"));
      };
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector("[data-name='".concat(name, "']")).closest('.preview__item');
  ...
  var progressInfo = function progressInfo(blockInfo) {
    blockInfo.style.bottom = 0;
    blockInfo.innerHTML = "<div class=\"uploading-progress\"></div>";
  };

  var uploadHandler = function uploadHandler() {
    var cancelBtns = preview.querySelectorAll('.preview__btn-cancel').forEach(function (btn) {
      return btn.remove();
    });
    var previewInfo = preview.querySelectorAll('.preview__item-info');
